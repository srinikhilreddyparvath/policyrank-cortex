...
The project started as a **PolicyRank-RL** prototype and evolved into a modular agentic ranking system with **semantic retrieval**, **LLM-based intent contracts**, **candidate filtering**, **slate-level reinforcement learning**, **critic verification**, **repair simulation**, and a **learned policy router**.
